...
public class Board_InfoVo {
	...
	public Board_InfoVo(int bor_no, int bor_act, String bor_name) { 
		this.bor_no = bor_no;
	...
	public String toString() {
		return "Board_InfoVo [bor_no=" + bor_no + ", bor_act=" + bor_act + ", bor_name=" + bor_name + "]";
	}
