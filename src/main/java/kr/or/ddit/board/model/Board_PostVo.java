...
public class Board_PostVo {
	...
	public Board_PostVo(int bor_no, int post_no, String user_id, String title,
						String cont, Date reg_dt, int post_del, int bor_c_nm, int post_c_no, String rep_user_id) {
		this.bor_no = bor_no;
	...
	public String toString() {
		return "Board_PostVo [bor_no=" + bor_no + ", post_no=" + post_no + ", user_id=" + user_id + ", title=" + title
